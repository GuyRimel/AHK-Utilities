...
ImageSearch, ydX, ydY, 0, 0, 400, A_ScreenHeight, *10 yellowDot.png
  if(errorlevel == 0){
    ydX+=1
    ydY+=1
    click, %ydX%, %ydY%
...
ImageSearch, FoundX, FoundY, 0, 0, 400, A_ScreenHeight, *10 cbNormal.png
  if(errorlevel == 0){
    click, %FoundX%, %FoundY%
    sleep, 500
  }
...
loop{
  ImageSearch, ydX, ydY, ydX, ydY, 400, A_ScreenHeight, *10 yellowDot.png
  if(errorlevel == 0){
    ydX+=1
    ydY+=1
    click, %ydX%, %ydY%
